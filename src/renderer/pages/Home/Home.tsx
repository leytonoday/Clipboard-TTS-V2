    ...
    <>
      ...
      <Box className="container" flexDirection={optionsBarPositionToflexDirection()} fontSize={['xs', 'sm', 'md']}>
        ...
        <Box
          data-step={1}
          data-intro={`
            This is the <b>Output Box</b>. All text output will be displayed here. For example, if you copy some text and have highlighting enabled, the text will be highlighted here.
          `}
          className="outputBox"
